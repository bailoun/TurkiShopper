...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "bvsxncteMMShippingatlibanexco" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["Account"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Customer"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Customer_Type"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Order"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Order_Categories"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Shipment"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Default Rates"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Received"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Sent"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["MMShipping_users"] = "bvsxncteMMShippingatlibanexco";
		$connectionsIds["Status"] = "bvsxncteMMShippingatlibanexco";
