...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "bvsxncteMMShippingatlibanexco";
		$data["connName"] = "bvsxncte_MMShipping at libanex";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;libanex.co;bvsxncte_mehdi_Admin;MfzHH@M2;;bvsxncte_MMShipping;;1"; //currently unused

		$this->_connectionsIdByName["bvsxncte_MMShipping at libanex"] = "bvsxncteMMShippingatlibanexco";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "bvsxncte_mehdi_Admin";
		$data["ODBCPWD"] = "MfzHH@M2";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "libanex.co";
		$data["connInfo"][1] = "bvsxncte_mehdi_Admin";
		$data["connInfo"][2] = "MfzHH@M2";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "bvsxncte_MMShipping";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=libanex.co;Uid=bvsxncte_mehdi_Admin;Pwd=MfzHH@M2;Database=bvsxncte_MMShipping;OPTION=3";
		// encription set
		...
		$connectionsData["bvsxncteMMShippingatlibanexco"] = $data;
