...
require_once("include/account_transactions_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Account_Transactions" );
