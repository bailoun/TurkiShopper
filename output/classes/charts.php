...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("Account" == $this->chrt_array['tables'][0])
			return true;
		if("Customer" == $this->chrt_array['tables'][0])
			return true;
		if("Customer_Type" == $this->chrt_array['tables'][0])
			return true;
		if("Order" == $this->chrt_array['tables'][0])
			return true;
		if("Order_Categories" == $this->chrt_array['tables'][0])
			return true;
		if("Shipment" == $this->chrt_array['tables'][0])
			return true;
		if("Default Rates" == $this->chrt_array['tables'][0])
			return true;
		if("Received" == $this->chrt_array['tables'][0])
			return true;
		if("Sent" == $this->chrt_array['tables'][0])
			return true;
		if("MMShipping_users" == $this->chrt_array['tables'][0])
			return true;
