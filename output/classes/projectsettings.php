...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "bvsxncteMMShippingatlibanexco";
		}
		return $connId;
	}
	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("MMShipping_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Account" ] = array( "url" => "account", "type" => 0 );
	$projectEntitiesReverse[ "account" ] = "Account";
	$projectEntities[ "Customer" ] = array( "url" => "customer", "type" => 0 );
	$projectEntitiesReverse[ "customer" ] = "Customer";
	$projectEntities[ "Customer_Type" ] = array( "url" => "customer_type", "type" => 0 );
	$projectEntitiesReverse[ "customer_type" ] = "Customer_Type";
	$projectEntities[ "Order" ] = array( "url" => "order", "type" => 0 );
	$projectEntitiesReverse[ "order" ] = "Order";
	$projectEntities[ "Order_Categories" ] = array( "url" => "order_categories", "type" => 0 );
	$projectEntitiesReverse[ "order_categories" ] = "Order_Categories";
	$projectEntities[ "Shipment" ] = array( "url" => "shipment", "type" => 0 );
	$projectEntitiesReverse[ "shipment" ] = "Shipment";
	$projectEntities[ "Default Rates" ] = array( "url" => "default_rates", "type" => 0 );
	$projectEntitiesReverse[ "default_rates" ] = "Default Rates";
	$projectEntities[ "Received" ] = array( "url" => "received", "type" => 0 );
	$projectEntitiesReverse[ "received" ] = "Received";
	$projectEntities[ "Sent" ] = array( "url" => "sent", "type" => 0 );
	$projectEntitiesReverse[ "sent" ] = "Sent";
	$projectEntities[ "MMShipping_users" ] = array( "url" => "mmshipping_users", "type" => 0 );
	$projectEntitiesReverse[ "mmshipping_users" ] = "MMShipping_users";
