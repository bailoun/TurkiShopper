...
class tDAL
{
	var $tblbvsxncteMMShippingatlibanexco__Account;
	var $tblbvsxncteMMShippingatlibanexco__Customer;
	var $tblbvsxncteMMShippingatlibanexco__Customer_Type;
	var $tblbvsxncteMMShippingatlibanexco__Default_Rates;
	var $tblbvsxncteMMShippingatlibanexco__MMShipping_users;
	var $tblbvsxncteMMShippingatlibanexco__Order;
	var $tblbvsxncteMMShippingatlibanexco__Order_Categories;
	var $tblbvsxncteMMShippingatlibanexco__Received;
	var $tblbvsxncteMMShippingatlibanexco__Sent;
	var $tblbvsxncteMMShippingatlibanexco__Shipment;
	var $tblbvsxncteMMShippingatlibanexco__Status;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "Account", "varname" => "bvsxncteMMShippingatlibanexco__Account", "altvarname" => "Account", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Customer", "varname" => "bvsxncteMMShippingatlibanexco__Customer", "altvarname" => "Customer", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Customer_Type", "varname" => "bvsxncteMMShippingatlibanexco__Customer_Type", "altvarname" => "Customer_Type", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Default Rates", "varname" => "bvsxncteMMShippingatlibanexco__Default_Rates", "altvarname" => "Default_Rates", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "MMShipping_users", "varname" => "bvsxncteMMShippingatlibanexco__MMShipping_users", "altvarname" => "MMShipping_users", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Order", "varname" => "bvsxncteMMShippingatlibanexco__Order", "altvarname" => "Order", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Order_Categories", "varname" => "bvsxncteMMShippingatlibanexco__Order_Categories", "altvarname" => "Order_Categories", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Received", "varname" => "bvsxncteMMShippingatlibanexco__Received", "altvarname" => "Received", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Sent", "varname" => "bvsxncteMMShippingatlibanexco__Sent", "altvarname" => "Sent", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Shipment", "varname" => "bvsxncteMMShippingatlibanexco__Shipment", "altvarname" => "Shipment", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
		$this->lstTables[] = array("name" => "Status", "varname" => "bvsxncteMMShippingatlibanexco__Status", "altvarname" => "Status", "connId" => "bvsxncteMMShippingatlibanexco", "schema" => "", "connName" => "bvsxncte_MMShipping at libanex");
	}
